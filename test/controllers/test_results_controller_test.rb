...
class TestResultsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create test_result" do
    assert_difference('TestResult.count') do
      post test_results_url, params: { test_result: { assignment_id: @test_result.assignment_id, pass: @test_result.pass } }
    end
  ...
  test "should update test_result" do
    patch test_result_url(@test_result), params: { test_result: { assignment_id: @test_result.assignment_id, pass: @test_result.pass } }
